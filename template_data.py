...
making sure they don't hurt much!""",
        ...
        },
        {
            ...
            "text_template": """Perhaps {name} will paint and draw,
...
making beauty of every kind!""",
        ...
        },
        {
            ...
            "text_template": """Maybe {name} will discover and explore,
...
making breakthroughs across the land!""",
        ...
        },
        {
            ...
            "text_template": """When {name} grows up making sweet sound,
...
bringing joy to me and you!""",
        ...
        },
        {
            ...
            "text_template": """Perhaps {name} will run and play,
...
building bridges across the lands!""",
        ...
        {
            "page_number": 13,
            "profession_title": "DENTIST",
            "text_template": """When {name} grows up caring for smiles,
...
keeping every tooth healthy and bright!""",
        ...
        },
        {
            ...
            "text_template": """Perhaps {name} will grow and tend,
...
making buildings that are here to stay!""",
        ...
        },
        {
            ...
            "text_template": """When {name} grows up loving books,
...
sharing knowledge for every need!""",
        ...
        },
        {
            ...
            "text_template": """Perhaps {name} will capture the light,
...
preserving moments as they fly by!""",
        ...
        },
        {
            ...
            "text_template": """Maybe {name} will care for creatures great,
...
giving them everything they need!""",
        ...
        },
        {
            ...
            "text_template": """When {name} grows up graceful and light,
...
connecting people just like glue!""",
        ...
        },
        {
            ...
            "text_template": """Maybe {name} will study the sea,
...
protecting oceans day and night!""",
        ...
        {
            "page_number": 22,
            "profession_title": "PARK RANGER",
            "text_template": """When {name} grows up protecting trees,
...
helping wildlife all around!""",
        ...
        {
            "page_number": 23,
            "profession_title": "BAKER",
            "text_template": """Perhaps {name} will knead and bake,
...
creating treats in every form!""",
        ...
        },
        {
            ...
            "text_template": """Whatever {name} chooses to be,
...
def get_pronouns(gender: str) -> dict:
    ...
    elif gender_lower == 'girl' or gender_lower == 'female':
        return {
            'he_she': 'she',
            'He_She': 'She',
            'his_her': 'her',
